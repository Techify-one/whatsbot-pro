...
Revision ID: 0047_source_id_native
Revises: 0046_message_agent_key
Create Date: 2026-07-09

Re-anchored onto 0046_message_agent_key at integration time (was 0045_mentions on
the plano-42 branch, which forked in parallel to 0046_message_agent_key). Kept a
linear DAG on developer instead of a second head.
"""
...
revision: str = "0047_source_id_native"
down_revision: Union[str, Sequence[str], None] = "0046_message_agent_key"
