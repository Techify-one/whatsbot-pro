...
No caso real, ambos os reads retornaram `https://whatsbot-dev.teste.techify.run/api/webhook/whatsapp_cloud/whatsapp_oficial_meta` — **domínio diferente** E **`channel_id` diferente** (`whatsapp_oficial_meta` ≠ `teste`).
