...
**Estado:** ⬜ Não iniciada
- **O que foi feito:** _()_
- **Como foi feito / decisões:** _(ponto único do OFF_BY_DEFAULT_TOOLS; confirmou que rows existentes não regridem)_
- **Problemas / pendências:** _()_
- **Verificação:** _(banco novo nasce OFF; banco existente inalterado; suíte Postgres)_
