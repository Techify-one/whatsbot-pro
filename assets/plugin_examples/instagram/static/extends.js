// Frontend extension do plugin instagram (espelha facebook_messenger). O app
...
// plugin e filtra por ``ctx.channel.provider === 'instagram'`` internamente, então
// só aparece nos cards de canal Instagram. O `api.http` (transporte status-aware
// namespaceado em /api/plugins/instagram) é injetado como prop — o componente não
// importa nada do core api.js.
