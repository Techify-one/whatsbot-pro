...
@router.post("/protocolos/{atid}/close", dependencies=[plugin_permission("edit")])
...
@router.post("/protocolos/{atid}/reopen", dependencies=[plugin_permission("edit")])
...
@router.post("/protocolos/{atid}/assign", dependencies=[plugin_permission("edit")])
...
@router.post("/atendimentos/{conversation_id}/resolve", dependencies=[plugin_permission("edit")])
