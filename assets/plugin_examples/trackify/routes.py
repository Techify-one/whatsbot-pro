...
def _reserved_slugs() -> dict:
    ...
    Todo campo escrito por uma AÇÃO da aba de consentimento entra aqui. Mapeá-lo
    também nesta aba ligaria o ``pull``, que traria o valor antigo do CDP de
    volta e poderia **desfazer** o que a ação gravou, sem ninguém pedir.
