...
5. a mensagem de bloqueio **cita a rota de escape**, senão um limite apertado
   deixaria o agente sem saída (R2).
    ...
    venv/bin/python -m pytest tests/integration/test_tool_limit_configuration.py -q
"""
...
def test_put_persists_limits_and_applies_them_without_restart(client, monkeypatch):
