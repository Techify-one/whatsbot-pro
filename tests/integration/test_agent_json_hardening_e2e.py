...
de verdade. Sem rede.
    ...
    venv/bin/python -m pytest tests/integration/test_agent_json_hardening_e2e.py -q
"""
...
from tests.integration.characterization.test_agent_turn_characterization import (
