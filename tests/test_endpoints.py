...
try:
    ...
    client.put("/api/config", json={"public_base_url": "http://10.8.200.103:8090"})
    ...
    r = client.get("/api/config", headers={
        "x-forwarded-host": "whatsbot-leandro.teste.techify.run",
        "x-forwarded-proto": "https"})
    check("public_base_url self-heal: IP de LAN -> domínio",
          r.json()["data"]["public_base_url"] == "https://whatsbot-leandro.teste.techify.run")
