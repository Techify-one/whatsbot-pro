...
# DB row so the channel-scoped endpoints (plano 21) resolve it (the registry-only
# fixture above makes it LIVE; the row makes channel_repo.get find it).
_chrepo.create(id="cloud_test", provider="whatsapp_cloud", display_name="Cloud Test", enabled=1)
